...
public class UserBindPhoneNumberFragment2 extends Fragment {
	...
	public UserBindPhoneNumberFragment2(UserBindPhoneNumberActivity mActivity) {
		this.mActivity = mActivity;
	}

	@Override
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View view = inflater.inflate(R.layout.fragment_user_bind_phone_number2, container, false);
		initViews(view);
		return view;
	}
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (WebDataRequestHelper.validateJsonResponse(msg)) {
				mActivity.bindPhoneNumber(phoneNumber);
			}
