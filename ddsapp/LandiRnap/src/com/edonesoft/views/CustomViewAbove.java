...
import com.edonesoft.views.SlidingMenu.OnClosedListener;
import com.edonesoft.views.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private static final int MAX_SETTLE_DURATION = 600; // ms,���Ķ���ʱ��
	private static final int MIN_DISTANCE_FOR_FLING = 25; // dips,��С����������
