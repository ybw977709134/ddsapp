...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode,
			TypedArray attrs) {
		LoadingLayout layout = new RotateLoadingLayout(context, mode,
			...
			if (mShowViewWhileRefreshing) {
				...
				case PULL_FROM_END:
					smoothScrollTo(getFooterSize(),
							getPullToRefreshScrollDuration(), 200, listener);
					break;
				default:
				case PULL_FROM_START:
	...
	protected void onReset() {
		...
		if (getMode() == Mode.PULL_FROM_END) {
			...
			smoothScrollTo(0, getPullToRefreshScrollDuration(), 800, null);
		}
	}

	protected void overScrolling() {
		mIsBeingDragged = false;
		mLayoutVisibilityChangesEnabled = true;
