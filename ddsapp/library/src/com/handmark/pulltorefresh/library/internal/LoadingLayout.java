...
public abstract class LoadingLayout extends FrameLayout implements
	...
	private CharSequence mResetLable;
	private CharSequence mFailLable;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		mResetLable = context.getString(R.string.pull_to_refresh_reset_label);
		mFailLable = context.getString(R.string.pull_to_refresh_fail_label);
	...
	public final void reset() {
		if (null != mHeaderText) {
			mHeaderText.setText(mResetLable);
		}
	...
	public final void refreshFail() {
		if (null != mHeaderText) {
			mHeaderText.setText(mFailLable);
		}
		if (mUseIntrinsicAnimation) {
			((AnimationDrawable) mHeaderImage.getDrawable()).stop();
		} else {
